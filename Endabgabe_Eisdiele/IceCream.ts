namespace icecreamshop {
    export class IceCream {
        ...
        private nScoops: number;
        private here: iceWhere;
        chosenTaste: String[];
        sauceChosen: boolean;
        toppingChosen: boolean;


        constructor(_scoopNumber: number, _desire: String[]) {
        ...
        where(_there: iceWhere): void {
            switch (_there) {
                case iceWhere.bottom:
                    this.position = new Vector(crc2.canvas.width - 250, crc2.canvas.height - 160);
                    this.here = iceWhere.bottom;
                    break;
                case iceWhere.inBubble:
                    this.position = new Vector(-100, -28);
                    this.here = iceWhere.inBubble;
                break;
                default:
                    break;
            }
        ...
        draw(_scale: number): void {
            ...
            // 2 scoops
                ...
                crc2.strokeStyle = "rgb(0, 0, 0)";
                crc2.fillStyle = "" + this.chosenTaste[1] + "";
                let scoop2: Path2D = new Path2D();
                crc2.beginPath();
            ...
            crc2.fillRect(-50 * _scale, 0, 100 * _scale, 100 * _scale);

            // scone
            crc2.strokeStyle = "rgb(0, 0, 0)";
            crc2.fillStyle = "rgb(252, 202, 129)";
            let scone: Path2D = new Path2D();
            crc2.beginPath();
        ...
        private drawSauce(_scale: number, _x: number, _y: number): void {
            ...
            switch (this.nScoops) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    crc2.fillStyle = "" + this.chosenTaste[3] + "";
                    break;
                default:
                    break;
            }
        ...
        private drawTopping(_scale: number, _x: number, _y: number): void {
            ...
            switch (this.nScoops) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    crc2.fillStyle = "" + this.chosenTaste[4] + "";
                    break;
                default:
                    break;
            }
            crc2.lineWidth = 0.572823;
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(-0.299324 * _scale, 0.954152 * _scale, -0.954152 * _scale, -0.299324 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(-7.109821 * _scale, -114.603000 * _scale, 2.522939 * _scale, 0.447103 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.909297 * _scale, -0.416147 * _scale, 0.416147 * _scale, 0.909297 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(83.377647 * _scale, 67.941010 * _scale, 2.522939 * _scale, 0.447103 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.859881 * _scale, -0.510495 * _scale, 0.510495 * _scale, 0.859881 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(68.643829 * _scale, 70.407272 * _scale, 2.522939 * _scale, 0.447103 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.880992 * _scale, -0.473131 * _scale, 0.000000 * _scale, 1.000000 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(96.586342 * _scale, 79.258904 * _scale, 2.863747 * _scale, 0.447103 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(-0.075386 * _scale, -0.997154 * _scale, 0.997154 * _scale, -0.075386 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(-39.047779 * _scale, 88.721352 * _scale, 2.522939 * _scale, 0.447103 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.649354 * _scale, -0.760486 * _scale, 0.760486 * _scale, 0.649354 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(38.433380 * _scale, 96.104507 * _scale, 2.522939 * _scale, 0.447103 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.972007 * _scale, 0.234954 * _scale, -0.234954 * _scale, 0.972007 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(114.132790 * _scale, 5.267094 * _scale, 2.522939 * _scale, 0.447103 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.316671 * _scale, -0.948536 * _scale, 0.948536 * _scale, 0.316671 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(0.375140 * _scale, 118.034420 * _scale, 2.522939 * _scale, 0.447103 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(-0.302536 * _scale, -0.953138 * _scale, 0.953138 * _scale, -0.302536 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(-63.049770 * _scale, 87.770088 * _scale, 2.522939 * _scale, 0.447103 * _scale);
            crc2.fill();
            crc2.restore();
        
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.776501 * _scale, 0.630116 * _scale, -0.630116 * _scale, 0.776501 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(95.483437 * _scale, -42.605083 * _scale, 2.709854 * _scale, 0.541971 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.827407 * _scale, 0.561603 * _scale, -0.561603 * _scale, 0.827407 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(94.634445 * _scale, -27.589279 * _scale, 2.709854 * _scale, 0.541971 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.718483 * _scale, -0.695544 * _scale, 0.695544 * _scale, 0.718483 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(40.218250 * _scale, 91.829048 * _scale, 2.709854 * _scale, 0.541971 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.991351 * _scale, -0.131237 * _scale, 0.131237 * _scale, 0.991351 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(99.991554 * _scale, 46.396057 * _scale, 2.709854 * _scale, 0.541971 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.894050 * _scale, -0.447967 * _scale, 0.447967 * _scale, 0.894050 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(86.009995 * _scale, 77.911469 * _scale, 2.709854 * _scale, 0.541971 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.949973 * _scale, 0.312332 * _scale, -0.312332 * _scale, 0.949973 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(110.166280 * _scale, -7.896353 * _scale, 2.709854 * _scale, 0.541971 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.972945 * _scale, -0.231036 * _scale, 0.231036 * _scale, 0.972945 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(92.074280 * _scale, 46.963367 * _scale, 2.709854 * _scale, 0.541971 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.984855 * _scale, -0.173378 * _scale, 0.173378 * _scale, 0.984855 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(91.230034 * _scale, 45.711487 * _scale, 2.709854 * _scale, 0.541971 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.893251 * _scale, -0.449558 * _scale, 0.449558 * _scale, 0.893251 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(58.228500 * _scale, 71.286766 * _scale, 2.709854 * _scale, 0.541971 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.771873 * _scale, 0.635776 * _scale, -0.483903 * _scale, 0.875122 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(106.791080 * _scale, -37.486076 * _scale, 2.293560 * _scale, 0.258384 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.957969 * _scale, 0.286872 * _scale, -0.286872 * _scale, 0.957969 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(96.962257 * _scale, 6.147088 * _scale, 2.746491 * _scale, 0.287423 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.384688 * _scale, -0.923046 * _scale, 0.923046 * _scale, 0.384688 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(-1.662899 * _scale, 89.982338 * _scale, 2.746491 * _scale, 0.287423 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.920746 * _scale, 0.390162 * _scale, -0.390162 * _scale, 0.920746 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(91.648079 * _scale, -5.480823 * _scale, 2.746491 * _scale, 0.287423 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.877339 * _scale, -0.479871 * _scale, 0.479871 * _scale, 0.877339 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(61.776764 * _scale, 67.681694 * _scale, 2.746491 * _scale, 0.287423 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.990832 * _scale, 0.135097 * _scale, -0.135097 * _scale, 0.990832 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(94.540688 * _scale, 13.487719 * _scale, 2.746491 * _scale, 0.287423 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.942694 * _scale, 0.333657 * _scale, -0.333657 * _scale, 0.942694 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(100.870040 * _scale, -9.104388 * _scale, 2.746491 * _scale, 0.287423 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.680489 * _scale, -0.732758 * _scale, 0.732758 * _scale, 0.680489 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(49.006874 * _scale, 97.588470 * _scale, 2.746491 * _scale, 0.287423 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.942863 * _scale, -0.333180 * _scale, 0.333180 * _scale, 0.942863 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(95.577980 * _scale, 69.004089 * _scale, 2.746491 * _scale, 0.287423 * _scale);
            crc2.fill();
            crc2.restore();
            
            crc2.save();
            crc2.beginPath();
            crc2.transform(0.907500 * _scale, 0.420052 * _scale, -0.420052 * _scale, 0.907500 * _scale, 0.000000 * _scale, 0.000000);
            crc2.rect(119.251780 * _scale, -17.512259 * _scale, 2.746491 * _scale, 0.287423 * _scale);
            crc2.fill();
            crc2.restore();
